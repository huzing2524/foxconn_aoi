...
def save_results(image, boxes, masks, class_ids, class_names, scores=None,
                        show_mask=True, show_bbox=True, save_dir=None, img_name=None):
    """
...
boxes = np.array([])
for b in gt_bbox:
    np.append(boxes, [0, b, gt_class_id[0]]) # TODO fix 0

save_results(original_image, boxes, np.array([gt_mask]), gt_class_id, 
    dataset_train.class_names, save_dir=ROOT_DIR, img_name="inferenced.png")
